...
function ClassCard({title, courseCode, type}: ClassCardProps) {
    var cardColour;
    switch (type) {
    ...
    return (
        <div className="flex flex-col p-5 py-2.5 w-72 gap-1 border-r-8 border-r-purple-400 shadow-sm rounded-md hover:bg-stone-100">
